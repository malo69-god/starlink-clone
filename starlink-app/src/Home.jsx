  ...
  return (
    <>
      ...
      <section id="hero" style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'row', gap: '20px', color: 'black', flexWrap: 'wrap', justifyContent: 'center', marginTop: '20px' }}>
          {/* Card 1 */}
          <div style={{
            width: '500px', height: '250px', backgroundColor: '#121111', 
            display: 'flex', flexDirection: 'column', color: 'white',
            textAlign: 'left', fontFamily: 'sans-serif', paddingLeft: '30px', borderRadius: '8px'
          }}>
            <div style={{ paddingTop: '10px' }}>
              <h2>Residential Lite</h2>
              <p>Up to 200 Mbps. Fast, reliable internet for everyday home use. Note: 90th percentile download speeds</p>
            </div> 
          ...
          <div style={{
            ...
            <div style={{ paddingTop: '10px' }}>
              <h2>Residential</h2>
              <p>Residential service for residential customers at one location.</p>
            </div> 
            <div style={{ paddingTop: '30px' }}>
              <h3 style={{ marginBottom: '5px' }}>Starting at</h3>
              <p style={{ fontSize: '2.5rem', fontWeight: 'bold', margin: 0 }}>GHS 700</p>
            </div>
          </div>
        </div>
      ...
      <section style={{
        ...
        <div style={{ 
          ...
          <h3 style={{ marginBottom: '10px', fontWeight: 'normal', lineHeight: '1.5' }}>
            Extreme weather conditions can cause significant disruptions to traditional internet networks. It is engineered to withstand heavy rain and harsh winds—keeping you connected with reliable, high-speed service when you need it most.
          </h3>
      ...
      <section style={{
        ...
        <div style={{ 
          ...
          <p style={{ marginBottom: '20px', fontWeight: 'normal', color: '#e4e4e4' }}>
            Delivering reliable connectivity in 160+ countries, territories, and other markets around the world.
          </p>
          <div style={{ display: 'flex', color: 'black' }}>
            <Buttonx style={{ color: 'black', width: '200px' }}>Check availability</Buttonx>
          </div>
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{ 
          ...
          <h1 style={{ margin: '0 0 10px 0', lineHeight: '1.2', color: '#2b2a2a' }}>
            Plug it in. Point at sky.
          </h1>
          <h3 style={{ marginBottom: '10px', fontWeight: 'normal', color: '#2b2a2a' }}>
            High-speed internet that moves with you, even in dead zones. In-motion use available in select areas.
          </h3>
          <div style={{ display: 'flex', marginTop: "50px", color: 'black' }}>
